...
namespace Elite
{
	...
	template<class T_NodeType, class T_ConnectionType>
	std::vector<T_NodeType*> GraphAlgorithm<T_NodeType, T_ConnectionType>::FindPath(T_NodeType* pStartNode, T_NodeType* pDestinationNode)
	{
		return std::vector<T_NodeType*>();
	}

	template<class T_NodeType, class T_ConnectionType>
	float Elite::GraphAlgorithm<T_NodeType, T_ConnectionType>::GetHeuristicCost(T_NodeType* pStartNode, T_NodeType* pEndNode) const
	{
